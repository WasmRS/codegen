...
impl MyStreamerComponent {
    ...
    fn request_stream_datetime_wrapper(
        input: IncomingMono,
    ...
    fn request_stream_args_i64_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_f64_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_type_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_enum_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_uuid_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_alias_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_string_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_bool_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_datetime_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_list_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
    ...
    fn request_stream_args_map_wrapper(
        input: IncomingMono,
    ) -> Result<OutgoingStream, GenericError> {
        let (out_tx, out_rx) = Flux::new_channels();
        let input = deserialize_helper(input);
        spawn(async move {
            ...
            fn des(
                ...
                Ok(my_streamer_service::request_stream_args_map::Input {value: <std::collections::HashMap<String,String> as serde::Deserialize>::deserialize(map.remove("value")
    .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?).map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?,})
            }
            let input = match des(input_payload) {
                Ok(o) => o,
                Err(e) => {
    ...
    fn request_channel_i64_wrapper(input: IncomingStream) -> Result<OutgoingStream, GenericError> {
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<i64 as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
                        ...
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <i64 as serde::Deserialize>::deserialize(a).map_err(|e| {
    ...
    fn request_channel_f64_wrapper(input: IncomingStream) -> Result<OutgoingStream, GenericError> {
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<f64 as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <f64 as serde::Deserialize>::deserialize(a).map_err(|e| {
                                        PayloadError::application_error(e.to_string())
                                    }),
                                );
                            }
    ...
    fn request_channel_type_wrapper(input: IncomingStream) -> Result<OutgoingStream, GenericError> {
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<MyType as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <MyType as serde::Deserialize>::deserialize(a).map_err(|e| {
                                        PayloadError::application_error(e.to_string())
                                    }),
                                );
                            }
    ...
    fn request_channel_enum_wrapper(input: IncomingStream) -> Result<OutgoingStream, GenericError> {
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<MyEnum as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <MyEnum as serde::Deserialize>::deserialize(a).map_err(|e| {
                                        PayloadError::application_error(e.to_string())
                                    }),
                                );
                            }
    ...
    fn request_channel_alias_wrapper(
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<Uuid as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <Uuid as serde::Deserialize>::deserialize(a).map_err(|e| {
                                        PayloadError::application_error(e.to_string())
                                    }),
                                );
                            }
    ...
    fn request_channel_string_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        let in_inner_tx = real_in_tx.clone();
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_string::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
                ...
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <String as serde::Deserialize>::deserialize(a).map_err(|e| {
                                        PayloadError::application_error(e.to_string())
                                    }),
                                );
                            }
    ...
    fn request_channel_bool_wrapper(input: IncomingStream) -> Result<OutgoingStream, GenericError> {
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<bool as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <bool as serde::Deserialize>::deserialize(a).map_err(|e| {
                                        PayloadError::application_error(e.to_string())
                                    }),
                                );
                            }
    ...
    fn request_channel_datetime_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_datetime::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
                let input =
                    my_streamer_service::request_channel_datetime::Input { r#in: real_in_rx };
    ...
    fn request_channel_list_wrapper(input: IncomingStream) -> Result<OutgoingStream, GenericError> {
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<Vec<String> as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(
                                    <Vec<String> as serde::Deserialize>::deserialize(a).map_err(
                                        |e| PayloadError::application_error(e.to_string()),
                                    ),
                                );
                            }
                        } else {
    ...
    fn request_channel_map_wrapper(input: IncomingStream) -> Result<OutgoingStream, GenericError> {
      ...
      if let Some(v) = map.remove("in"){let _ = in_inner_tx.send_result(<std::collections::HashMap<String,String> as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));}
      Ok(input)
    };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
                spawn(async move {
                    while let Ok(Some(Ok(payload))) = input.recv().await {
                        if let Ok(mut payload) = deserialize_generic(&payload.data) {
                            if let Some(a) = payload.remove("in") {
                                let _ = real_in_tx.send_result(<std::collections::HashMap<String,String> as serde::Deserialize>::deserialize(a).map_err(|e| PayloadError::application_error(e.to_string())),
        );
                            }
                        } else {
                            break;
    ...
    fn request_channel_args_i64_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_i64::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_f64_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_f64::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_type_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_type::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_enum_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_enum::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_alias_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_alias::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_string_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_string::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_bool_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_bool::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_datetime_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_datetime::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_list_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_list::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
    ...
    fn request_channel_args_map_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_args_map::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
                let input = my_streamer_service::request_channel_args_map::Input {value: <std::collections::HashMap<String,String> as serde::Deserialize>::deserialize(map.remove("value")
    .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?).map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?,
r#in: real_in_rx,};

                if let Some(v) = map.remove("in") {
                    let _ = in_inner_tx.send_result(<std::collections::HashMap<String,String> as serde::Deserialize>::deserialize(v).map_err(|e| PayloadError::application_error(e.to_string())));
                }
                Ok(input)
            };
            let input_map = if let Ok(Some(Ok(first))) = input.recv().await {
    ...
    fn request_channel_non_stream_output_wrapper(
        input: IncomingStream,
    ) -> Result<OutgoingStream, GenericError> {
        let (real_out_tx, real_out_rx) = Flux::new_channels();
        let (real_in_tx, real_in_rx) = Flux::new_channels();
        ...
        spawn(async move {
            let des = move |payload: ParsedPayload| -> Result<
                my_streamer_service::request_channel_non_stream_output::Input,
                Error,
            > {
                let mut map = deserialize_generic(&payload.data)?;
                let input = my_streamer_service::request_channel_non_stream_output::Input {
                    r#in: real_in_rx,
                };
...
pub mod my_streamer_service {
    ...
    pub mod request_stream_map {
        ...
        pub(crate) type Output =
            FluxReceiver<std::collections::HashMap<String, String>, PayloadError>;
    }
...
impl MyServiceComponent {
    ...
    fn unary_type_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<MyType, Error> {
                Ok(<MyType as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_enum_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<MyEnum, Error> {
                Ok(<MyEnum as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_uuid_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<Uuid, Error> {
                Ok(<Uuid as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_alias_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<MyAlias, Error> {
                Ok(<MyAlias as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_string_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<String, Error> {
                Ok(<String as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_i64_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<i64, Error> {
                Ok(<i64 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_i32_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<i32, Error> {
                Ok(<i32 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_i16_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<i16, Error> {
                Ok(<i16 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_i8_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<i8, Error> {
                Ok(<i8 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_u64_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<u64, Error> {
                Ok(<u64 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_u32_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<u32, Error> {
                Ok(<u32 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_u16_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<u16, Error> {
                Ok(<u16 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_u8_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<u8, Error> {
                Ok(<u8 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_f64_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<f64, Error> {
                Ok(<f64 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_f32_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(mut map: std::collections::BTreeMap<String, Value>) -> Result<f32, Error> {
                Ok(<f32 as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_bytes_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<wasmrs_guest::Bytes, Error> {
                Ok(<wasmrs_guest::Bytes as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
    ...
    fn unary_datetime_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<wasmrs_guest::Timestamp, Error> {
                Ok(
    ...
    fn unary_list_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                ...
                Ok(<Vec<String> as serde::Deserialize>::deserialize(
                    map.remove("value")
                        .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?,
                )
                .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?)
            ...
            fn des(
                ...
                Ok(my_service_service::func_type::Input {
                    ...
                    optional: <Option<MyType> as serde::Deserialize>::deserialize(
                        map.remove("optional").ok_or_else(|| {
                            wasmrs_guest::Error::MissingInput("optional".to_owned())
                        })?,
                    )
                    .map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?,
                })
    ...
    fn func_i64_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_i64::Input, Error> {
    ...
    fn func_i32_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_i32::Input, Error> {
    ...
    fn func_i16_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_i16::Input, Error> {
    ...
    fn func_i8_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_i8::Input, Error> {
    ...
    fn func_u64_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_u64::Input, Error> {
    ...
    fn func_u32_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_u32::Input, Error> {
    ...
    fn func_u16_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_u16::Input, Error> {
    ...
    fn func_u8_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_u8::Input, Error> {
    ...
    fn func_f64_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_f64::Input, Error> {
    ...
    fn func_f32_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_f32::Input, Error> {
    ...
    fn func_map_wrapper(input: IncomingMono) -> Result<OutgoingMono, GenericError> {
        ...
        spawn(async move {
            ...
            fn des(
                mut map: std::collections::BTreeMap<String, Value>,
            ) -> Result<my_service_service::func_map::Input, Error> {
                Ok(my_service_service::func_map::Input {value: <std::collections::HashMap<String,String> as serde::Deserialize>::deserialize(map.remove("value")
    .ok_or_else(|| wasmrs_guest::Error::MissingInput("value".to_owned()))?).map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?,
optional: <Option<std::collections::HashMap<String,String>> as serde::Deserialize>::deserialize(map.remove("optional")
    .ok_or_else(|| wasmrs_guest::Error::MissingInput("optional".to_owned()))?).map_err(|e| wasmrs_guest::Error::Decode(e.to_string()))?,})
            }
...
pub(crate) trait MyServiceService {
    ...
    async fn unary_type(
        input: MyType,
    ) -> Result<my_service_service::unary_type::Output, GenericError>;

    async fn unary_enum(
        input: MyEnum,
    ) -> Result<my_service_service::unary_enum::Output, GenericError>;

    async fn unary_uuid(
        input: Uuid,
    ) -> Result<my_service_service::unary_uuid::Output, GenericError>;

    async fn unary_alias(
        input: MyAlias,
    ) -> Result<my_service_service::unary_alias::Output, GenericError>;

    async fn unary_string(
        input: String,
    ) -> Result<my_service_service::unary_string::Output, GenericError>;
    ...
    async fn unary_bytes(
        input: wasmrs_guest::Bytes,
    ) -> Result<my_service_service::unary_bytes::Output, GenericError>;
    ...
    async fn unary_list(
        input: Vec<String>,
    ) -> Result<my_service_service::unary_list::Output, GenericError>;
...
pub(crate) fn init_exports() {
    ...
    wasmrs_guest::register_request_response(
        "iota.testing.MyService",
        "funcI8",
        MyServiceComponent::func_i8_wrapper,
    );
    ...
    wasmrs_guest::register_request_response(
        "iota.testing.MyService",
        "funcU8",
        MyServiceComponent::func_u8_wrapper,
    );
